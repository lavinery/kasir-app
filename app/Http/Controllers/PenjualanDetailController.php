...
class PenjualanDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $keuntungan_per_item = $produk->harga_jual - $produk->harga_beli;
        $detail->keuntungan = $keuntungan_per_item * $detail->jumlah;
        $detail->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $keuntungan_per_item = $produk->harga_jual - $produk->harga_beli;
        $detail->keuntungan = $keuntungan_per_item * $request->jumlah;
        $detail->update();
    }
    ...
    public function loadForm($diskon = 0, $total = 0, $diterima = 0)
    {
        ...
        $total_keuntungan = PenjualanDetail::where('id_penjualan', $id_penjualan)->sum('keuntungan');
        ...
        $data = [
            ...
            'keuntunganrp' => format_uang($total_keuntungan),
        ];
