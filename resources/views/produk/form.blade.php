...
<div class="form-group row">
    <label for="keuntungan" class="col-lg-2 col-lg-offset-1 control-label">Keuntungan</label>
    <div class="col-lg-6">
        <input type="number" name="keuntungan" id="keuntungan" class="form-control" readonly>
        <span class="help-block with-errors"></span>
    </div>
</div>
